defmodule Binance.ClientTest do
  ...
  #   Application.stop(:binance_client) |> IO.inspect()
  #   ## stop genserver started based on mix.exs for crypto_trader_web
  ...
  describe "start_link/1" do
    test "starts the binance genserver pricing status of not_loaded" do
      ...
      assert %{pricing: :not_loaded} == GenServer.call(Binance.Client, :get)
    end
...
## old tests from before refactor
# describe "start_link/1" do
